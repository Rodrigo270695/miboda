    ...
    <WeddingPage invitedName={guest.invited_name}>
      <section id="rsvp" className="px-10 py-16 text-center">
        <div className="w-full rounded-3xl border border-[rgba(212,175,55,0.4)] bg-white/88 px-5 py-7 shadow-[0_18px_45px_rgba(90,33,69,0.12)]">
          ...
          {guest.rsvp ? (
            <div className="mx-auto mt-8 max-w-md rounded-3xl border border-[var(--line)] bg-[rgba(255,245,248,0.95)] p-5 text-center">
              <p className="text-lg text-[var(--fuchsia)]">
            ...
            <form action={confirmInvitation} className="mx-auto max-w-md">
              ...
              <button className="rounded-full bg-[var(--fuchsia)] px-8 py-4 text-base font-semibold uppercase tracking-[0.24em] text-white shadow-[0_16px_34px_rgba(216,27,96,0.22)] transition hover:bg-[var(--ink)]">
                Confirmar invitacion
              </button>
            </form>
          )}
